...
<img src="/assets/images/Hydrangea.png" alt="The most massive galaxy cluster" style="display: block; margin-left: 
auto; margin-right: auto; width: 75%"/>
<figcaption>Visualization of the most massive galaxy cluster simulated as part of the Hydrangea project. The 
brightness of the image represents the gas density, while the colour encodes the temperature of the gas (blue: cold, 
white: hot).</figcaption>
...
<figcaption>Projected gas density is shown on the left, gas temperature on the right (white is hottest, black 
coldest).</figcaption>
...
[GCS's](https://www.gauss-centre.eu/nc/results/astrophysics/article/hydrangea-simulating-the-formation-of-galaxies-in-clusters/?cHash=17ccc14d442d1180ea62105d7d7bb348&sword_list%5B0%5D=hydrangea){:target="_blank"}
project description page or contact
[Yannick Bahé](https://www.universiteitleiden.nl/en/staffmembers/yannick-bahe#tab-1){:target="_blank"}.